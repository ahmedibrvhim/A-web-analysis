...
export const dict = {
  en: {
    ...
    tool_fix_approx: '⚠ Approx. crop only — landmarks in the next step are estimated, verify them',
    ...
    tool_side_mirror: '⇄ Points on the wrong side? Flip to other side',
  ...
  ar: {
    ...
    tool_fix_approx: '⚠ اقتصاص تقريبي فقط — النقاط في الخطوة التالية مقدَّرة، تحقق منها',
    ...
    tool_side_mirror: '⇄ النقاط على الجانب الخطأ؟ اقلبها للجانب الآخر',
