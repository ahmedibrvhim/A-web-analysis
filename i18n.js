...
export const dict = {
  en: {
    ...
    tool_step_upload_side_text: 'Optional, but it lets the engine detect head tilt and correct your ratio automatically. Turn your head 90° so your ear is visible.',
    tool_drop_cta: 'Drag & drop a photo here, or click to browse',
    tool_change_photo: 'Change Photo',
    tool_skip_side: 'Skip This Step →',
    tool_use_side: 'Use This Photo →',
    tool_back: '← Back',
    tool_continue: 'Continue →',
    tool_analyzing: 'Reading Your Landmarks…',
    tool_step_adjust_title: 'Confirm The Landmarks',
    tool_step_adjust_text: 'Four points were placed automatically. Drag any of them to correct their position — your measurement is only as accurate as these dots.',
    ...
    tool_err_file_type: 'Please upload a JPG or PNG image.',
    tool_err_save: 'Could not save your result. Please try again.',
    tool_manual_hint: 'Detection unavailable — place the four points manually by clicking on the photo.',
  },
  ar: {
    /* ── nav / common ── */
    nav_home: 'الرئيسية',
    ...
    tool_step_upload_side_text: 'اختيارية، لكنها تتيح للمحرك اكتشاف ميل الرأس وتصحيح نسبتك تلقائياً. أدر رأسك ٩٠ درجة حتى تظهر أذنك.',
    tool_drop_cta: 'اسحب وأفلت صورة هنا، أو اضغط للاختيار',
    tool_change_photo: 'تغيير الصورة',
    tool_skip_side: 'تخطي هذه الخطوة ←',
    tool_use_side: 'استخدام هذه الصورة ←',
    tool_back: '→ رجوع',
    tool_continue: 'متابعة ←',
    tool_analyzing: 'جارٍ تحديد النقاط المرجعية…',
    tool_step_adjust_title: 'تأكيد النقاط المرجعية',
    tool_step_adjust_text: 'تم وضع أربع نقاط تلقائياً. اسحب أي نقطة لتصحيح موضعها — دقة القياس تعتمد بالكامل على دقة هذه النقاط.',
    ...
    tool_err_file_type: 'الرجاء رفع صورة بصيغة JPG أو PNG.',
    tool_err_save: 'تعذر حفظ نتيجتك. الرجاء المحاولة مجدداً.',
    tool_manual_hint: 'الكشف التلقائي غير متاح — ضع النقاط الأربع يدوياً بالنقر على الصورة.',
  }
};
