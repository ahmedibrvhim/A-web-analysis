...
export const dict = {
  en: {
    ...
    archetype_short: 'Compact Lower Third — youthful, tightly-proportioned face',
    archetype_balanced_short: 'Balanced-Short — slightly compact, clean lower face',
    archetype_golden: 'Golden Ratio — textbook classical balance',
    archetype_elongated: 'Elongated — strong, dominant jaw presence',
    archetype_long: 'Long Lower Third — elongated, horse-like proportions',
    rating_chad: 'Chad',
    rating_above_avg: 'Above Average',
  ...
  ar: {
    ...
    archetype_short: 'ثلث سفلي مضغوط — وجه شاب متناسق بإحكام',
    archetype_balanced_short: 'متوازن-قصير قليلاً — وجه سفلي نظيف ومضغوط قليلاً',
    archetype_golden: 'النسبة الذهبية — توازن كلاسيكي مثالي',
    archetype_elongated: 'ممتد — حضور فك قوي ومهيمن',
    archetype_long: 'ثلث سفلي طويل — تناسب ممتد',
    rating_chad: 'تشاد',
    rating_above_avg: 'فوق المتوسط',
