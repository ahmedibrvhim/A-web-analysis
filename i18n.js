...
export const dict = {
  en: {
    ...
    tool_err_no_face: "We couldn't detect a face in this photo — please upload a clear photo of a face.",
  ...
  ar: {
    ...
    tool_err_no_face: 'تعذر التعرف على وجه في هذه الصورة — الرجاء رفع صورة واضحة لوجه.',
