...
export const dict = {
  en: {
    ...
    tool_dash_hint: 'Tap a point, then nudge it with the arrows — or tap the photo to drop it exactly where it belongs.',
    tool_dash_place_label: 'Tap Photo To Place',
  ...
  ar: {
    ...
    tool_dash_hint: 'اضغط على نقطة، ثم حرّكها بالأسهم — أو اضغط على الصورة لوضعها بدقة في مكانها الصحيح.',
    tool_dash_place_label: 'اضغط الصورة للوضع',
